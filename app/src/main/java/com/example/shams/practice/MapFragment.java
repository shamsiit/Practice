...
public class MapFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        autocompleteFragment = (PlaceAutocompleteFragment) getActivity().getFragmentManager().findFragmentById(R.id.place_autocomplete_fragment1);
    ...
    public void onStop() {
       ...
       /* Fragment fragment = getActivity().getSupportFragmentManager().findFragmentById(R.id.map1);
        if(fragment != null)
            getActivity().getSupportFragmentManager().beginTransaction().remove(fragment).commit();

        Fragment fragment1 = getActivity().getSupportFragmentManager().findFragmentById(R.id.place_autocomplete_fragment1);
        if(fragment1 != null)
    ...
    public void onDestroyView() {
        ...
        PlaceAutocompleteFragment fragment1 = (PlaceAutocompleteFragment) getActivity().getFragmentManager().findFragmentById(R.id.place_autocomplete_fragment1);
        ...
        SupportMapFragment fragment2 = (SupportMapFragment) getFragmentManager().findFragmentById(R.id.map1);
        if(fragment2 != null){
